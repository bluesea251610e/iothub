...
```bash
go get -u github.com/bluesea251610e/iothub
```

To install CLI applications:

```bash
GO111MODULE=on go get -u github.com/bluesea251610e/iothub/cmd/{iothub-service,iothub-device}
```
...
import (
	...
	iotmqtt "github.com/bluesea251610e/iothub/iotdevice/transport/mqtt"
)
